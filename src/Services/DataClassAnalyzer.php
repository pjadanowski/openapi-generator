...
class DataClassAnalyzer
{
    ...
    public function processDataClass(string $className): string
    {
    ...
    public function getPropertySchema(ReflectionProperty $property): Schema
    {
    ...
    public function convertReflectionTypeToSchema(ReflectionType $type, ?ReflectionProperty $property = null): Schema
    {
    ...
    private function handleNamedType(ReflectionNamedType $type, ?ReflectionProperty $property = null): Schema
    {
    ...
    private function handleUnionType(ReflectionUnionType $type, ?ReflectionProperty $property = null): Schema
    {
        $types = $type->getTypes();
    ...
    private function handleCollectionType(?ReflectionProperty $property = null): Schema
    {
        if (!$property) {
            return new Schema(['type' => 'array', 'items' => new Schema(['type' => 'string'])]);
        }
